...
MaquinaLv is a component library for Phoenix LiveView inspired by shadcn/ui. It provides reusable UI components styled with TailwindCSS 4.0 using data-attribute CSS selectors and CSS variables for theming.
